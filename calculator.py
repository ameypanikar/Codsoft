...
btn_multi=tk.Button(window, text="x", command=lambda: add_to_calculation("x"),width=5, font=("Arial", 14))
btn_multi.grid(row=4,column=4)
btn_divide=tk.Button(window, text="/", command=lambda: add_to_calculation("/"),width=5, font=("Arial", 14))
